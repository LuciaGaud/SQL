...
CASE 
    WHEN 
        (RevenueAIRPeriod1 + RevenueFCLPeriod1 + RevenueLCLGRPPeriod1 + RevenueLCLOTHPeriod1 + RevenueOTHPeriod1) != 0 
    THEN 
        CAST(
            (RevenueAIRPeriod2 + RevenueFCLPeriod2 + RevenueLCLGRPPeriod2 + RevenueLCLOTHPeriod2 + RevenueOTHPeriod2) 
            - (RevenueAIRPeriod1 + RevenueFCLPeriod1 + RevenueLCLGRPPeriod1 + RevenueLCLOTHPeriod1 + RevenueOTHPeriod1)
            AS FLOAT
        ) 
        / CAST(
            (RevenueAIRPeriod1 + RevenueFCLPeriod1 + RevenueLCLGRPPeriod1 + RevenueLCLOTHPeriod1 + RevenueOTHPeriod1) 
